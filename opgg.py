...
players = [{"name": "Madueño","account": "Koon Eduan"},{"name": "Manu Sanchez","account":"EseOGThueleaPDT"},{"name": "Juaki","account": "ElMessiDelRoneo"},
	   {"name": "Pae","account": "AlanBritoDelgado"},{"name": "Juanca","account": "Titojuankaisback"},{"name": "Ale R","account": "SQCurry"},{"name": "Fernandito","account": "Tito Destru IRL"},{"name": "Hectroll","account": "iRfAnastasia"},{"name": "Roldan","account": "CICOCHALLENGE"},{"name": "Tayson","account": "Pørnstar PT1"},{"name": "Oreja","account": "xØrewY"},{"name": "Lucena","account": "LucenaK"}]
################################################################################
