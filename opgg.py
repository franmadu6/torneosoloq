...
players = [{"name": "Madueño","account": "Koon Eduan"},{"name": "Manu Sanchez","account":"EseOGThueleaPDT"},{"name": "Juaki","account": "ElMessiDelRoneo"},
	   {"name": "Pae","account": "AlanBritoDelgado"},{"name": "Juanca","account": "Titojuankaisback"},{"name": "Fernandito","account": "Tito Destru IRL"},{"name": "Hectroll","account": "iRfAnastasia"},{"name": "Roldan","account": "CICOCHALLENGE"},{"name": "Tayson","account": "A Saltar"},{"name": "Oreja","account": "xØrewY"},{"name": "Lucena","account": "LucenaK"}]
################################################################################
